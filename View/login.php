...
<a href="login.php" class="w3-bar-item w3-button">Connexion</a>
  ...
  <a href="#" class="w3-bar-item w3-button">Reservation</a>
      ...
      <a class="w3-bar-item" style="text-decoration:none"><i>AGENCE DE VOYAGE</i></a>
		  </div>
</div>
...
<div class="height" style="margin-bottom:80px;">
    <div  class="w3-half margin-left">
       <img src="../Public/images/2.png" style="width:75%">
    </div>
  ...
  <div class="mb-3">
    <label  class="form-label" autocomplete="off">Mot De Passe</label>
    <input type="password" class="form-control" >
  </div>
  <div class="mb-3 ">
    Pas de compte? <a href="register.php"><span class="amber"> S'inscrire</span></a>
  </div>
  
 <a href="#"><button type="submit" class="btn btn-primary">SE CONNECTER</button></a> 
</form>
    </div>
</div>
<footer class="w3-container w3-padding-32 w3-grey">  
  ...
  <div class="w3-xlarge w3-padding-32">
    ...
    <div class="posfooter">
    Copyright@<a href="#" target="_blank" style="text-decoration:none">2022</a>
  </div>
        </div>
    </div>
  </footer>
